...
/*		List<String> ut = new ArrayList<String>();
	...
	public void aggiornaPaziente(Paziente paz, String cognome,String nome, String sesso, Date datanascita, String codicefiscale, String indirizzo, String citta, String cap, String provincia, String professione,
			String telefono1, String telefono2, String email, String numTessSanit, String note){
			//close();
			getSession();
			begin();
