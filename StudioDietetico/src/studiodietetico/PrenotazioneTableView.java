...
public class PrenotazioneTableView extends ViewPart {
	...
	classVis = new TableForm(top, SWT.BORDER, prenotazioni, "createSShellDettagliPrenotazione","createSShellPrenotaVisita",PrenotazioneTableView.this,vd,"PrenotazioneTableView");
	...
	public static void aggiungiColonne(TableForm classVis, ArrayList<Object> prenotazioni) {
	...
	public void createSShellDettagliPrenotazione(final TableItem rigaTableClick) {
		...
		sShellDettagliPrenotazione = new Shell(SWT.APPLICATION_MODAL | SWT.SHELL_TRIM);
		...
		textPazientePren.setText(pren.getPaziente().getCognome()+" "+pren.getPaziente().getNome());
		...
		textCostoVisita.setText(""+pren.getTipologiavisita().getCostoVisita());
		...
		textAreaNotePren = new Text(sShellDettagliPrenotazione, SWT.MULTI | SWT.WRAP | SWT.V_SCROLL);
		...
		buttonChiudiDettagliPren = new Button(sShellDettagliPrenotazione, SWT.NONE);
